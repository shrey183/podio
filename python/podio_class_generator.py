...
class ClassGenerator(object):
    ...
    def process_datatypes(self, content):
        ...
        print 'ClassGenerator process_datatypes TRIGGERED'
    ...
    def get_template(self, filename):
        ...
        print 'ClassGenerator get_template TRIGGERED'
    ...
    def create_class(self, classname, definition):
      ...
      print 'ClassGenerator create_class TRIGGERED'
      namespace, rawclassname, namespace_open, namespace_close = self.demangle_classname(classname)
    ...
    def create_collection(self, classname, definition):
      ...
      print 'ClassGenerator create_collection TRIGGERED'
    ...
    def create_PrintInfo(self, classname, definition):
        ...
        print 'ClassGenerator create_PrintInfo TRIGGERED'
...
#        print  " comp: " , classname , " name : " , name
  ...
  #    for name, klass in components.items():
    ...
    def create_obj(self, classname, definition):
      ...
      print 'ClassGenerator create_obj TRIGGERED'
      namespace, rawclassname, namespace_open, namespace_close = self.demangle_classname(classname)
    ...
    def prepare_vectorized_access(self, classname,members ):
      print 'ClassGenerator prepare_vectorized_access TRIGGERED'
      implementation = ""
      declaration = ""
      for member in members:
        name = member["name"]
    ...
    def evaluate_template(self, filename, substitutions):
        """ reads in a given template, evaluates it
            and returns result
        """
        print 'ClassGenerator evaluate_template TRIGGERED'
